        ...
        <div className="min-h-screen bg-gray-50 p-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow p-6 mb-6">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="px-3 py-1 rounded-full text-sm font-medium bg-purple-100 text-purple-800">
                            Zona: {report.store_zona}
                        </span>
                        {/* Para admin: permitir ver chat y cerrar en todos los estados excepto completed */}
                        {report.status !== 'completed' && (
                            <>
                                ...
                                >
                                    {report.status === 'draft' ? 'Ver Chat (Borrador)' : 'Ir al Chat'}
                                </Link>
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-3">
                                    <p className="text-sm text-yellow-700">
                                        <strong>Estado Borrador:</strong> Este reporte fue creado por el conductor pero aún no ha sido enviado. 
                                        El conductor está completando los pasos del flujo de reporte.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <ReportDetailContent
                    ...
                    messages={messages || []}
                    evidence={evidence}
                    chatUrl={`/admin/chat/${id}`}
                    hasChat={report.status !== 'completed'}
                />
